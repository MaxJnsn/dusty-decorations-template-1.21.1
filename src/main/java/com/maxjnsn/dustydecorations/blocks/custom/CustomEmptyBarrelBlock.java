...
public class CustomEmptyBarrelBlock extends Block {
    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;

    // Define the filling and wall shapes
    private static final VoxelShape BARREL_FILLING = Block.createCuboidShape(2, 0, 2, 14, 2, 14); // 12x12x14 barrel filling
    ...
    public CustomEmptyBarrelBlock(Settings settings) {
        super(settings);
    }
